    ...
    this.client.addEventHandler(async (event) => {
      ...
      try {
        ...
        if (shouldRespond) {
          ...
          const template = ((_b = (_a = this.runtime.character) == null ? void 0 : _a.templates) == null ? void 0 : _b.messageHandlerTemplate) || getTelegramAccountMessageHandlerTemplate(this.account);
